...
const downloadBuildDependencies = require('./download.archive');
...
async function isoBuild(context) {
    ...
    try {
        // TODO: this needs a proper workaround to avoid errors during copy-operations
        await Promise.all([
            fs.emptyDir(isoDir),
            fs.emptyDir(bootDir),
        ...
        await downloadBuildDependencies(isolinuxDir);
